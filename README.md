...
<title>Driving Operational Excellence — Microsoft Security Portals</title>
<meta name="description" content="A daily, weekly, and monthly rhythm for the Microsoft Security Portals: Defender, Purview, and Entra.">
<style>
  :root {
    --bg: #ffffff;
    --text: #1f2933;
  ...
  * { box-sizing: border-box; }
  ...
  h1, h2, h3, h4 { color: var(--accent); line-height: 1.25; margin-top: 1.6em; margin-bottom: 0.5em; }
  h1 { font-size: 2.4rem; font-weight: 700; margin-top: 0; border-bottom: 3px solid var(--accent); padding-bottom: 0.4em; }
  h2 { font-size: 1.7rem; font-weight: 700; border-bottom: 1px solid var(--border); padding-bottom: 0.3em; }
  h3 { font-size: 1.3rem; font-weight: 600; }
  h4 { font-size: 1.1rem; font-weight: 600; color: var(--text); }
  p { margin: 0.8em 0; }
  a { color: var(--accent); text-decoration: none; border-bottom: 1px solid rgba(6, 90, 130, 0.3); transition: border-color 0.15s; }
  ...
  th { font-weight: 600; border-color: var(--accent); }
  ...
  .lead strong { display: block; color: var(--accent); margin-bottom: 4px; }
